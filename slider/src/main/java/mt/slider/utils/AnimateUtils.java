...
//    public static float mAnimationScaleSizeMultipler;

    public static AnimationSet startSliderAnimation(final View view, SliderHelper.AnimationTypes animeType,  float mAnimationScaleSizeMultipler) {
        view.requestLayout();
        ...
        switch (animeType) {
            case CENTER_TO_RIGHT:
                ...
                // Scale
                scaleAnimation = getScaleAnimation(1f, 1f / mAnimationScaleSizeMultipler, ANIMATION_DURATION);
                // Translate
