 ...
 */
public class BlankFragment extends Fragment implements View.OnClickListener, OnSliderIndexChangeListener {
    ...
    private void updateLabel(int newIndex) {
        String label = mSliderItemList.get(newIndex).getLabel();
